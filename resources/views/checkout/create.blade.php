...
@section('content')
    <div class="mb-4 lg:mb-6 text-center lg:text-left">
        ...
        <h1 class="font-serif text-2xl sm:text-3xl font-medium text-stone-900 leading-[1.2]">Lengkapi data pengambilan cake</h1>
    </div>
            ...
            <div class="bg-white border border-stone-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm">
                <form method="POST" action="{{ route('checkout.store') }}" class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                        <div class="sm:col-span-2">
                            <h3 class="font-serif text-xl font-medium text-stone-800 mb-1">Pengambilan</h3>
                            <p class="text-[11px] sm:text-xs text-stone-500 mb-4">Pesanan Anda akan diambil langsung di toko.</p>
                        </div>

                        <div class="sm:col-span-2">
                            <div class="bg-stone-50 p-4 rounded-xl border border-stone-200 flex items-center gap-3">
                                <div class="p-2.5 bg-pink-100 text-pink-600 rounded-lg">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                    </svg>
                                </div>
                                <div>
                                    <div class="text-xs font-bold text-stone-700 uppercase tracking-wide">Metode</div>
                                    <div class="text-sm font-medium text-stone-900">Ambil di Toko (Pickup)</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="order_notes" rows="2" class="w-full px-3 py-2.5 bg-stone-50 border border-stone-200 rounded-lg text-xs sm:text-sm focus:bg-white focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 outline-none transition resize-none" placeholder="Catatan khusus untuk pesanan Anda...">{{ old('order_notes') }}</textarea>
                        </div>
                ...
                <div class="border-t border-pink-200/50 pt-4">
                    ...
                    <div class="bg-white/50 p-2.5 rounded-lg border border-pink-100 mb-2 flex items-start gap-1.5">
                        ...
                        <p class="text-[9px] text-stone-500 font-medium leading-tight">
                            Pesanan ini diambil langsung di toko. Pastikan untuk mengambil pesanan Anda sesuai dengan tanggal dan waktu yang telah dijadwalkan.
                        </p>
                    </div>
                </div>
            </div>
