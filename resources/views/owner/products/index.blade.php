                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                ...
                                @if($search !== '')
                                    ...
                                    <a href="{{ route("owner.products.index") }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-pink-600 text-white text-xs font-medium hover:bg-pink-700 transition">
                                        Reset Pencarian
                                    </a>
                                @else
