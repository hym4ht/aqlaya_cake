...
@section('content')
    ...
    <div class="mb-12 flex items-end justify-between">
        ...
        <a href="{{ route('catalog') }}" class="px-5 py-2.5 border border-stone-300 text-stone-700 rounded-lg text-sm font-medium hover:bg-stone-900 hover:text-white hover:border-stone-900 transition-all">
            Pesan Lagi
        </a>
    </div>
    ...
    <div class="space-y-4">
        @forelse($orders as $order)
            <div class="bg-white rounded-2xl p-6 border border-stone-200 hover:border-stone-300 transition-all">
                ...
                <div class="flex items-center justify-between pt-5 border-t border-stone-100">
                    ...
                    <a href="{{ route('orders.show', $order) }}" class="px-4 py-2 bg-stone-900 text-white rounded-lg text-sm font-medium hover:bg-stone-800 transition-colors">
                        Lihat Detail
                    </a>
                </div>
            </div>
        @empty
            <div class="bg-stone-50 border border-stone-200 border-dashed rounded-2xl p-16 text-center">
                ...
                <a href="{{ route('catalog') }}" class="inline-flex items-center px-5 py-2.5 bg-stone-900 text-white rounded-lg text-sm font-medium hover:bg-stone-800 transition-colors">
                    Lihat Katalog
                </a>
            </div>
        @endforelse
